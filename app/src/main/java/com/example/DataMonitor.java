...
//		}
    ...
    public void ControlClick(View v) {
        ...
        if (id == R.id.button1) {
            ...
            ((TextView) findViewById(R.id.tvDataName1)).setText("X轴：");
            ((TextView) findViewById(R.id.tvNum1)).setText("0");
            ((TextView) findViewById(R.id.tvDataName2)).setText("Y轴：");
            ((TextView) findViewById(R.id.tvNum2)).setText("0");
            ((TextView) findViewById(R.id.tvDataName3)).setText("Z轴：");
            ((TextView) findViewById(R.id.tvNum3)).setText("0");
            ((TextView) findViewById(R.id.tvDataName4)).setText("温度：");
...
//                iCurrentGroup = 0;
//                ((TextView) findViewById(R.id.tvDataName1)).setText("日期：");
//                ((TextView) findViewById(R.id.tvNum1)).setText("2015-1-1");
//                ((TextView) findViewById(R.id.tvDataName2)).setText("时间：");
...
//                iCurrentGroup = 6;
//                ((TextView) findViewById(R.id.tvDataName1)).setText("气压：");
//                ((TextView) findViewById(R.id.tvNum1)).setText("0");
//                ((TextView) findViewById(R.id.tvDataName2)).setText("海拔：");
//                ((TextView) findViewById(R.id.tvNum2)).setText("0");
//                ((TextView) findViewById(R.id.tvDataName3)).setText("");
//                ((TextView) findViewById(R.id.tvNum3)).setText("");
//                ((TextView) findViewById(R.id.tvDataName4)).setText("");
...
//                iCurrentGroup = 7;
//                ((TextView) findViewById(R.id.tvDataName1)).setText("经度：");
//                ((TextView) findViewById(R.id.tvNum1)).setText("0");
//                ((TextView) findViewById(R.id.tvDataName2)).setText("纬度：");
//                ((TextView) findViewById(R.id.tvNum2)).setText("0");
//                ((TextView) findViewById(R.id.tvDataName3)).setText("");
//                ((TextView) findViewById(R.id.tvNum3)).setText("");
//                ((TextView) findViewById(R.id.tvDataName4)).setText("");
...
//                iCurrentGroup = 8;
//                ((TextView) findViewById(R.id.tvDataName1)).setText("海拔：");
//                ((TextView) findViewById(R.id.tvNum1)).setText("0");
//                ((TextView) findViewById(R.id.tvDataName2)).setText("航向：");
//                ((TextView) findViewById(R.id.tvNum2)).setText("0");
//                ((TextView) findViewById(R.id.tvDataName3)).setText("地速");
//                ((TextView) findViewById(R.id.tvNum3)).setText("0");
//                ((TextView) findViewById(R.id.tvDataName4)).setText("");
//                ((TextView) findViewById(R.id.tvNum4)).setText("");
//                break;
...
//                iCurrentGroup = 10;
//                ((TextView) findViewById(R.id.tvDataName1)).setText("卫星数：");
//                ((TextView) findViewById(R.id.tvNum1)).setText("0");
